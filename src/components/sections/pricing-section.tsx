...
/** Glowing gold flare divider — matches client reference under the price */
function PriceGlowDivider() {
  return (
    <div className="relative my-6 h-[2px] w-full" aria-hidden>
      ...
      />
      {/* Main streak: transparent → gold → bright center → gold → transparent */}
      <div
  ...
  return (
    <ScrollReveal direction="up" delay={delay} once className="h-full">
      ...
      >
        ...
        {/* Glowing divider under price */}
        <PriceGlowDivider />

        {/* Features — gold dash bullets */}
  ...
  return (
    ...
    >
      <Container className="relative z-10">
        {/* Header: title left, copy right — matches reference layout */}

...
const STEPS = [
  ...
  },
  {
    ...
    body: "30 credits (£59.99) is enough to onboard your first customers without over-committing. You'll learn the panel inside-out with real customers on real lines.",
  },
  {
